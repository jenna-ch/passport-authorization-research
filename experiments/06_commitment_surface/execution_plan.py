...
# ADAPTED FROM 08_refusal_feedback/execution_plan.py (itself adapted from P3-B).
# The ONLY difference is that the run_id prefix is a named constant
# instead of the literal "p3b", so P3-B2 records cannot be confused with
# P3-B records. Offline gate 13b diffs this file against P3-B's and
# asserts that this is the sole difference. Everything else — the
# block-interleaving, the digest, the verification and the resumption
